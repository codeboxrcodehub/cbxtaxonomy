...
if (!\function_exists('grapheme_extract') && !\function_exists('CbxTaxonomyScoped\grapheme_extract')) {
...
if (!\function_exists('grapheme_stripos') && !\function_exists('CbxTaxonomyScoped\grapheme_stripos')) {
    function grapheme_stripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_stripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_stristr') && !\function_exists('CbxTaxonomyScoped\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('CbxTaxonomyScoped\grapheme_strlen')) {
    function grapheme_strlen($input)
    {
        return p\Grapheme::grapheme_strlen($input);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('CbxTaxonomyScoped\grapheme_strpos')) {
    function grapheme_strpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strripos') && !\function_exists('CbxTaxonomyScoped\grapheme_strripos')) {
    function grapheme_strripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strrpos') && !\function_exists('CbxTaxonomyScoped\grapheme_strrpos')) {
    function grapheme_strrpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strrpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strstr') && !\function_exists('CbxTaxonomyScoped\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('CbxTaxonomyScoped\grapheme_substr')) {
    function grapheme_substr($string, $offset, $length = null)
    {
        return p\Grapheme::grapheme_substr($string, $offset, $length);
    }
}
if (!\function_exists('grapheme_str_split') && !\function_exists('CbxTaxonomyScoped\grapheme_str_split')) {
