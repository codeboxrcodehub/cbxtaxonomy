...
if (!\function_exists('normalizer_is_normalized') && !\function_exists('CbxTaxonomyScoped\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('CbxTaxonomyScoped\normalizer_normalize')) {
