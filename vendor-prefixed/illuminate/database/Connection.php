...
use CbxTaxonomyScoped\Doctrine\DBAL\Connection as DoctrineConnection;
use CbxTaxonomyScoped\Doctrine\DBAL\Types\Type;
use Exception;
use CbxTaxonomyScoped\Illuminate\Contracts\Events\Dispatcher;
use CbxTaxonomyScoped\Illuminate\Database\Events\QueryExecuted;
use CbxTaxonomyScoped\Illuminate\Database\Events\StatementPrepared;
use CbxTaxonomyScoped\Illuminate\Database\Events\TransactionBeginning;
use CbxTaxonomyScoped\Illuminate\Database\Events\TransactionCommitted;
use CbxTaxonomyScoped\Illuminate\Database\Events\TransactionRolledBack;
use CbxTaxonomyScoped\Illuminate\Database\Query\Builder as QueryBuilder;
use CbxTaxonomyScoped\Illuminate\Database\Query\Expression;
use CbxTaxonomyScoped\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use CbxTaxonomyScoped\Illuminate\Database\Query\Processors\Processor;
use CbxTaxonomyScoped\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return class_exists('CbxTaxonomyScoped\Doctrine\DBAL\Connection');
    }
    /**
