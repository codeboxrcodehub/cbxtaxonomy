...
namespace CbxTaxonomyScoped\Illuminate\Database\Console\Factories;

use CbxTaxonomyScoped\Illuminate\Console\GeneratorCommand;
...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    protected function buildClass($name)
    {
        ...
        if (Str::startsWith($namespaceModel, $this->rootNamespace() . 'Models')) {
            ...
            $namespace = 'CbxTaxonomyScoped\Database\Factories';
        }
