...
namespace CbxTaxonomyScoped\Illuminate\Database\Console;

use CbxTaxonomyScoped\Illuminate\Console\Command;
use CbxTaxonomyScoped\Illuminate\Contracts\Events\Dispatcher;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\MassPrunable;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Prunable;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\SoftDeletes;
use CbxTaxonomyScoped\Illuminate\Database\Events\ModelsPruned;
use CbxTaxonomyScoped\Illuminate\Support\Str;
use InvalidArgumentException;
use CbxTaxonomyScoped\Symfony\Component\Finder\Finder;
