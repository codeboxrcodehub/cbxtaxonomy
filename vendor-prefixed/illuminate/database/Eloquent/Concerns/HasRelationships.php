...
namespace CbxTaxonomyScoped\Illuminate\Database\Eloquent\Concerns;

use Closure;
use CbxTaxonomyScoped\Illuminate\Database\ClassMorphViolationException;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Builder;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Collection;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Model;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\BelongsTo;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\HasMany;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\HasOne;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\MorphMany;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\MorphOne;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\MorphTo;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\MorphToMany;
use CbxTaxonomyScoped\Illuminate\Database\Eloquent\Relations\Relation;
