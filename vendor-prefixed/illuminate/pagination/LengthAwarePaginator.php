...
namespace CbxTaxonomyScoped\Illuminate\Pagination;

use ArrayAccess;
use Countable;
use CbxTaxonomyScoped\Illuminate\Contracts\Pagination\LengthAwarePaginator as LengthAwarePaginatorContract;
...
class LengthAwarePaginator extends AbstractPaginator implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable, LengthAwarePaginatorContract
{
    ...
    public function linkCollection()
    {
        ...
        })->prepend(['url' => $this->previousPageUrl(), 'label' => function_exists('CbxTaxonomyScoped\__') ? __('pagination.previous') : 'Previous', 'active' => \false])->push(['url' => $this->nextPageUrl(), 'label' => function_exists('CbxTaxonomyScoped\__') ? __('pagination.next') : 'Next', 'active' => \false]);
    }
    /**
