...
$languages = \CbxTaxonomyScoped\voku\helper\ASCII::getAllLanguages();
$languagesKeyLengths = [];
foreach ($languages as $language) {
    $langSpecific = \CbxTaxonomyScoped\voku\helper\ASCII::charsArrayWithOneLanguage($language, \false, \false);
