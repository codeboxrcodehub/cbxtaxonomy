 ...
 */
namespace CbxTaxonomyScoped\Carbon\Traits;

use CbxTaxonomyScoped\Carbon\CarbonInterface;
use CbxTaxonomyScoped\Carbon\Exceptions\InvalidTypeException;
use CbxTaxonomyScoped\Carbon\Exceptions\NotLocaleAwareException;
use CbxTaxonomyScoped\Carbon\Language;
use CbxTaxonomyScoped\Carbon\Translator;
use CbxTaxonomyScoped\Carbon\TranslatorStrongTypeInterface;
use Closure;
use CbxTaxonomyScoped\Symfony\Component\Translation\TranslatorBagInterface;
use CbxTaxonomyScoped\Symfony\Component\Translation\TranslatorInterface;
use CbxTaxonomyScoped\Symfony\Contracts\Translation\LocaleAwareInterface;
use CbxTaxonomyScoped\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('CbxTaxonomyScoped\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('CbxTaxonomyScoped\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('CbxTaxonomyScoped\Symfony\Contracts\Translation\TranslatorInterface', 'CbxTaxonomyScoped\Symfony\Component\Translation\TranslatorInterface');
}
